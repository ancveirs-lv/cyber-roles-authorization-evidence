...
| Jēdziens | Vienā teikumā |
|---|---|
| Hakeris | Plašs un kontekstjutīgs kultūras/tehnisks apzīmējums, ne precīzs juridisks statuss |
| Drošības pētnieks | Pēta drošības īpašības vai ievainojamības; nosaukums pats par sevi nedod testēšanas atļauju |
| Penetrācijas testētājs | Autorizēti pārbauda noteiktu tehnisku tvērumu pēc iesaistes noteikumiem |
| Red Team | Autorizēti imitē pretinieku, lai pārbaudītu novēršanu, atklāšanu un reakciju |
| Blue Team | Aizsargā, uzrauga, atklāj, analizē un reaģē |
...
## Pieci jautājumi publiskam apgalvojumam

1. Kādā **lomā** cilvēks runā?
2. Kādiem pierādījumiem viņam bija **piekļuve**?
3. Kas ir paša konstatēts un kas nāk no cita **avota**?
